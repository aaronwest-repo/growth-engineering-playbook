...
| 27 | [`revenue-demand-forecast`](27-revenue-demand-forecast) | Demo-ready | Revenue forecast with honest uncertainty: log-linear trend + monthly seasonality, prediction intervals that widen with the horizon, and a backtest (MAPE + interval coverage) that shows whether to trust it |
